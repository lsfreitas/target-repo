...
def get_commits_from_pull_request(pr):
    ...
    if commit_messages:
        logging.info(f"Formatted commit messages from PR: {commit_messages}")
    else:
        logging.info("No commits found in the pull request.")
